...
export default function NewApprovalRulePage() {
  ...
  const handleSubmit = async () => {
    ...
    if (ruleType === 'PERCENTAGE' && !percentageRequired) {
      setError('Percentage is required for percentage-based approval');
      return;
    }

    if (ruleType === 'SPECIFIC_APPROVER' && !specificApproverId) {
      setError('Specific approver is required');
      return;
    }
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Configure a new expense approval workflow</p>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  This rule applies when expense amount exceeds this threshold
                </p>
              </div>
